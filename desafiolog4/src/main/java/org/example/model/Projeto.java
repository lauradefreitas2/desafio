...
public class Projeto {
    ...
    public Projeto(String numeroSequencia, Date dataInicio, Date dataFinal, StatusDesenvolvimento statusDesenvolvimento, DominioAtendimento dominioAtendimento, List<Desenvolvedor> desenvolvedores) {
